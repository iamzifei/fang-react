...
var AddPropertyActions = function () {
    ...
    _createClass(AddPropertyActions, [{
        ...
        value: function AddProperty(name, gender) {
            ...
            $.ajax({
                ...
                _this.actions.AddPropertyFail(jqXhr.responseJSON.message);
            });
        }
    }]);
...
exports.default = _alt2.default.createActions(AddPropertyActions);
...
var HomeActions = function () {
    function HomeActions() {
        ...
        this.generateActions('getAllPropertiesSuccess', 'getAllPropertiesFail');
    }
    ...
    _createClass(HomeActions, [{
        ...
        value: function getAllProperties() {
            ...
            $.ajax({ url: '/api/properties' }).done(function (data) {
                _this.actions.getAllPropertiesSuccess(data);
            }).fail(function (jqXhr) {
                _this.actions.getAllPropertiesFail(jqXhr.responseJSON.message);
            });
        }
    }]);
...
var NavbarActions = function () {
  function NavbarActions() {
    ...
    this.generateActions('updateAjaxAnimation', 'updateSearchQuery', 'getPropertyCountSuccess', 'getPropertyCountFail', 'findPropertySuccess', 'findPropertyFail');
  }

  _createClass(NavbarActions, [{
    key: 'findProperty',
    value: function findProperty(payload) {
      var _this = this;
      ...
      $.ajax({
        ...
        _this.actions.findPropertySuccess(payload);
      }).fail(function () {
        _this.actions.findPropertyFail(payload);
      });
    }
  }, {
    key: 'getPropertyCount',
    value: function getPropertyCount() {
      var _this2 = this;

      $.ajax({ url: '/api/properties/count' }).done(function (data) {
        _this2.actions.getPropertyCountSuccess(data);
      }).fail(function (jqXhr) {
        _this2.actions.getPropertyCountFail(jqXhr);
      });
    }
  }]);
...
var PropertyFeatureActions = function PropertyFeatureActions() {
  _classCallCheck(this, PropertyFeatureActions);

  this.generateActions();
};

exports.default = _alt2.default.createActions(PropertyFeatureActions);
...
var SearchActions = function () {
    function SearchActions() {
        ...
        this.generateActions('getResultSuccess', 'getResultFail');
    }

    _createClass(SearchActions, [{
        key: 'getPropertiesInSuburb',
        value: function getPropertiesInSuburb(suburb) {
            var _this = this;

            $.ajax({ url: '/api/properties/' + suburb }).done(function (data) {
                _this.actions.getResultSuccess(data);
            }).fail(function (jqXhr) {
                _this.actions.getResultFail(jqXhr.responseJSON.message);
            });
        }
    }]);
...
var _AddPropertyStore = require('../stores/AddPropertyStore');

var _AddPropertyStore2 = _interopRequireDefault(_AddPropertyStore);

var _AddPropertyActions = require('../actions/AddPropertyActions');

var _AddPropertyActions2 = _interopRequireDefault(_AddPropertyActions);
...
},{"../actions/AddPropertyActions":1,"../stores/AddPropertyStore":17,"react":"react"}],9:[function(require,module,exports){
'use strict';
...
var _PropertyFeature = require('./PropertyFeature');

var _PropertyFeature2 = _interopRequireDefault(_PropertyFeature);
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      _HomeActions2.default.getAllProperties();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
...
},{"../actions/HomeActions":3,"../stores/HomeStore":19,"./PropertyFeature":13,"react":"react","react-router":"react-router","underscore":"underscore"}],12:[function(require,module,exports){
'use strict';
...
var Navbar = function (_React$Component) {
  ...
  _createClass(Navbar, [{
    ...
    value: function componentDidMount() {
      ...
      _NavbarActions2.default.getPropertyCount();
    ...
    value: function handleSubmit(event) {
      ...
      if (searchQuery) {
        _NavbarActions2.default.findProperty({
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: this.state.totalProperties + ' properties', value: this.state.searchQuery, onChange: _NavbarActions2.default.updateSearchQuery }),
              _react2.default.createElement(
                'span',
...
var _PropertyFeatureStore = require('../stores/PropertyFeatureStore');

var _PropertyFeatureStore2 = _interopRequireDefault(_PropertyFeatureStore);

var _PropertyFeatureActions = require('../actions/PropertyFeatureActions');

var _PropertyFeatureActions2 = _interopRequireDefault(_PropertyFeatureActions);
...
var PropertyFeature = function (_React$Component) {
  _inherits(PropertyFeature, _React$Component);

  function PropertyFeature(props) {
    _classCallCheck(this, PropertyFeature);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PropertyFeature).call(this, props));

    _this.state = _PropertyFeatureStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }

  _createClass(PropertyFeature, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _PropertyFeatureStore2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _PropertyFeatureStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
    ...
    value: function render() {
      ...
      var propertyFeatureNodes = this.props.propertyFeatures.map(function (propertyFeature, index) {
        return _react2.default.createElement(
          'li',
          { key: propertyFeature },
          propertyFeatureNames[propertyFeature]
        );
      });
...
},{"../actions/PropertyFeatureActions":5,"../stores/PropertyFeatureStore":21,"react":"react","react-router":"react-router","underscore":"underscore"}],14:[function(require,module,exports){
'use strict';
...
var Search = function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function componentDidMount() {
      ...
      _SearchActions2.default.getPropertiesInSuburb(this.props.params.suburb);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          ' Properties in ',
          (0, _underscore2.default)(suburbName).capitalize()
        ),
        _react2.default.createElement(
          'div',
          { className: 'row' },
...
},{"../actions/SearchActions":6,"../stores/SearchStore":22,"./PropertyFeature":13,"react":"react","react-router":"react-router","underscore":"underscore"}],15:[function(require,module,exports){
'use strict';
...
var _AddProperty = require('./components/AddProperty');
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { path: '/add', component: _AddProperty2.default }),
  _react2.default.createElement(_reactRouter.Route, { path: '/properties/:suburb', component: _Search2.default })
);

},{"./components/AddProperty":8,"./components/App":9,"./components/Home":11,"./components/Search":14,"react":"react","react-router":"react-router"}],17:[function(require,module,exports){
'use strict';
...
},{"../actions/AddPropertyActions":1,"../alt":7}],18:[function(require,module,exports){
'use strict';
...
var HomeStore = function () {
    ...
    _createClass(HomeStore, [{
        key: 'onGetAllPropertiesSuccess',
        value: function onGetAllPropertiesSuccess(data) {
            this.properties = data;
        }
    }, {
        key: 'onGetAllPropertiesFail',
        value: function onGetAllPropertiesFail(errorMessage) {
...
var NavbarStore = function () {
    ...
    _createClass(NavbarStore, [{
        key: 'onFindPropertySuccess',
        value: function onFindPropertySuccess(payload) {
            payload.history.pushState(null, '/properties/' + payload.suburb);
        }
    }, {
        key: 'onFindPropertyFail',
        value: function onFindPropertyFail(payload) {
        ...
        key: 'onGetPropertyCountSuccess',
        value: function onGetPropertyCountSuccess(data) {
            this.totalProperties = data.count;
        }
    }, {
        key: 'onGetPropertyCountFail',
        value: function onGetPropertyCountFail(jqXhr) {
...
var PropertyFeatureStore = function PropertyFeatureStore() {
  _classCallCheck(this, PropertyFeatureStore);

  this.bindActions(_PropertyFeatureActions2.default);
};

exports.default = _alt2.default.createStore(PropertyFeatureStore);

},{"../actions/PropertyFeatureActions":5,"../alt":7}],22:[function(require,module,exports){
'use strict';
...
var SearchStore = function () {
    ...
    _createClass(SearchStore, [{
        key: 'onGetResultSuccess',
        value: function onGetResultSuccess(data) {
            this.properties = data;
        }
    }, {
        key: 'onGetResultFail',
        value: function onGetResultFail(errorMessage) {
            toastr.error(errorMessage);
        }
    }]);
...
},{"../actions/SearchActions":6,"../alt":7}],23:[function(require,module,exports){
